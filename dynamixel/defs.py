...
REGISTER_AXS1 = enumeration.Enumeration( [
    ...
    ('SoundDetectedTimeL',  38, "Sound Detected Time (First Half of Value)"),
    ('SoundDetectedTimeH',  39, "Sound Detected Time (Second Half of Value)"),
    ('BuzzerIndex',  40, "Note to play (0-51)"),
    ('BuzzerTime',  41, "How long to play note, plus special values. See Manual"),
    ('PresentVoltage',  42, "Present Voltage" ),
    ('PresentTemp',  43, "Present Temperature" ),
    ('RegisteredInstruction',  44, "Registered Instruction" ),
